...
<div class="progress">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="bajigur" placeholder="Contoh: ciawi" name="tempat_lahir" value="<?php echo $peserta->tempat_lahir;?>">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="bajigur" placeholder="Contoh:: SMP TRAKAL" name="nama_sekbel" value="<?php echo $peserta->nama_sekbel;?>">
    </div>
  </div>

  <div class="form-group">
    <label for="bajigur" class="col-sm-2 control-label">NPSN SMP/MTS</label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    <label for="bajigur" class="col-sm-2 control-label">Status SMP/MTS</label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    <label for="bajigur" class="col-sm-2 control-label">Kabupaten SMP/MTS</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="bajigur" placeholder="Contoh: ciawi" name="nama_kabsekbel" value="<?php echo $peserta->nama_kabsekbel;?>">
    </div>
  </div>
...
<div class="progress">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="bajigur" placeholder="Contoh: ciawi" name="kab_ortu" value="<?php echo $peserta->kab_ortu;?>">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="bajigur" placeholder="COntoh: ciawi" name="tempat_lahir_ayah" value="<?php echo $peserta->tempat_lahir_ayah;?>">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="bajigur" placeholder="Contoh: ciawi" name="tempat_lahir_ibu" value="<?php echo $peserta->tempat_lahir_ibu;?>">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="bajigur" placeholder="Contoh: ciawi" name="tempat_lahir_wali" value="<?php echo $peserta->tempat_lahir_wali;?>">
    </div>
  </div>
