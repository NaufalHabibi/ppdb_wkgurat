...
<head>
    ...
    <!-- Icon Font CSS -->
    <link rel="stylesheet" href="assets2/css/icons.min.css">
...
<header class="header-area">
    <div class="header-top bg-img" style="background-image:url(assets2/img/icon-img/header-shape.png);">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-7 col-12 col-sm-8">
                    <div class="header-contact">
                        <ul>
                            <li><i class="fa fa-phone"></i> 0351-749709</li>
                            <li><i class="fa fa-envelope-o"></i><a href="#">ppdb@mtsn3ngawi.sch.id</a></li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <!-- <div class="col-lg-2 col-md-6 col-4">
                    <div class="logo">
                        <a href="index.html">
                            <img alt="" src="assets2/img/logo/logo.png">
                        </a>
                    </div>
                </div> -->
                                    ...
                                    <ul>
                                        <li class="single-shopping-cart">
                                            <div class="shopping-cart-img">
                                                <a href="#"><img alt="" src="assets2/img/cart/cart-1.png"></a>
                                            </div>
                                        ...
                                        <li class="single-shopping-cart">
                                            <div class="shopping-cart-img">
                                                <a href="#"><img alt="" src="assets2/img/cart/cart-2.png"></a>
                                            </div>
                                            <div class="shopping-cart-title">
                                                <h4><a href="#">Color Box </a></h4>
                                                <h6>Qty: 02</h6>
...
<div class="slider-area">
    <div class="slider-active owl-carousel">
        <div class="single-slider slider-height-2 bg-img align-items-center d-flex slider-overlay2-1 default-overlay" style="background-image:url(assets2/img/slider/slider-2.jpg);">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                        <div class="slider-content slider-content-2 slider-animated-2 text-center">
                            <h1 class="animated">Selamat datang di portal PPDB SMK Wikrama 1 Garut</h1>
                            <p class="animated">Ini merupakan halaman resmi ppdb online pada SMK Wikrama 1 Garut. Untuk melakukan pendaftaran, silahkan klik tombol daftar dibawah ini. </p>
                            <div class="slider-btn">
                                <a class="animated default-btn btn-green-color" href="about-us.html">DAFTAR</a>
        ...
        <div class="single-slider slider-height-2 align-items-center d-flex bg-img slider-overlay2-2 default-overlay" style="background-image:url(assets2/img/slider/slider-3.jpg);">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                        <div class="slider-content slider-content-2 slider-animated-2 text-center">
        ...
        <div class="single-slider slider-height-2 align-items-center d-flex bg-img slider-overlay2-3 default-overlay" style="background-image:url(assets2/img/slider/slider-4.jpg);">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                        <div class="slider-content slider-content-2 slider-animated-2 text-center">
        ...
        <div class="row align-items-center">
           <div class="col-lg-7 col-md-12">
                <div class="about-img about-img-2 default-overlay mr-70">
                    <img src="assets2/img/banner/banner-2.jpg" alt="">
                    <a class="video-btn video-popup" href="https://www.youtube.com/watch?v=sv5hK4crIRc">
                        <img src="assets2/img/icon-img/video.png" alt="">
                    </a>
                </div>
            </div>
            <div class="col-lg-5 col-md-12">
                <div class="about-content-2 pr-70">
                    ...
                    <img src="assets2/img/banner/banner-3.jpg" alt="">
                    <div class="signature mt-30">
                        <img src="assets2/img/icon-img/signature.png" alt="">
                    </div>
                ...
                <div class="row"> 
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="single-choose-us2 mb-45 text-center">
                            <img src="assets2/img/icon-img/service-5.png" alt="">
                            <h4>Creative & Tecnology Base</h4>
                            <p>magna aliqua. Ut enim ad minim <br>aliqui ptempor incid.</p>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="single-choose-us2 mb-45 text-center choose-padding">
                            <img src="assets2/img/icon-img/service-6.png" alt="">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="single-choose-us2 mb-45 text-center">
                            <img src="assets2/img/icon-img/service-7.png" alt="">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="single-choose-us2 mb-45 text-center choose-padding">
                            <img src="assets2/img/icon-img/service-8.png" alt="">
                            <h4>Best lab facilities</h4>
                            <p>magna aliqua. Ut enim ad minim <br>aliqui ptempor incid.</p>
                        </div>
                    </div>
...
<div class="admission-area pt-125 pb-130 bg-img-position">
    <div class="container">
        ...
        <div class="admission-tab-list nav pt-80 pb-60">
            <a class="active" href="#course-categorie-1" data-toggle="tab" >
                <h4>all </h4>
            </a>
            <a href="#course-categorie-2" data-toggle="tab">
                <h4> Undergraduate Courses </h4>
            </a>
            <a href="#course-categorie-3" data-toggle="tab">
                <h4>Graduate Courses </h4>
            </a>
            <a href="#course-categorie-4" data-toggle="tab">
            ...
            <div class="tab-pane active" id="course-categorie-1">
                <div class="course-slider-active-2 nav-style-1 owl-carousel">
                    <div class="course-categorie-bundle">
                        <div class="single-course mb-30">
                            <div class="course-img">
                                <a href="course-details.html"><img src="assets2/img/course/course-5.jpg" alt=""></a>
                            </div>
                            <div class="course-content course-content-2">
                                <h4><a href="course-details.html">Courses Title Here</a></h4>
                                <p>Veniam, nisi ut aliquiptempor incid idunt ut labore et dolore. </p>
                            </div>
                        </div>
                        <div class="single-course mb-30">
                            <div class="course-img">
                                <a href="course-details.html"><img src="assets2/img/course/course-9.jpg" alt=""></a>
                    ...
                    <div class="course-categorie-bundle">
                        <div class="single-course mb-30">
                            <div class="course-img">
                                <a href="course-details.html"><img src="assets2/img/course/course-6.jpg" alt=""></a>
                            </div>
                            <div class="course-content course-content-2">
                        ...
                        <div class="single-course mb-30">
                            <div class="course-img">
                                <a href="course-details.html"><img src="assets2/img/course/course-10.jpg" alt=""></a>
                            </div>
                            <div class="course-content course-content-2">
                                <h4><a href="course-details.html">Grphic Design & Multimedia</a></h4>
                                <p>Veniam, nisi ut aliquiptempor incid idunt ut labore et dolore. </p>
                    ...
                    <div class="course-categorie-bundle">
                        <div class="single-course mb-30">
                            <div class="course-img">
                                <a href="course-details.html"><img src="assets2/img/course/course-7.jpg" alt=""></a>
                            </div>
                            <div class="course-content course-content-2">
                        ...
                        <div class="single-course mb-30">
                            <div class="course-img">
                                <a href="course-details.html"><img src="assets2/img/course/course-11.jpg" alt=""></a>
                            </div>
                            <div class="course-content course-content-2">
                                <h4><a href="course-details.html">Computer Engineering</a></h4>
                                <p>Veniam, nisi ut aliquiptempor incid idunt ut labore et dolore. </p>
                    ...
                    <div class="course-categorie-bundle">
                        <div class="single-course mb-30">
                            <div class="course-img">
                                <a href="course-details.html"><img src="assets2/img/course/course-8.jpg" alt=""></a>
                                <span class="new-course">New Course</span>
                            </div>
                            <div class="course-content course-content-2">
                        ...
                        <div class="single-course mb-30">
                            <div class="course-img">
                                <a href="course-details.html"><img src="assets2/img/course/course-12.jpg" alt=""></a>
                                <span class="new-course">New Course</span>
                            </div>
                            <div class="course-content course-content-2">
                                <h4><a href="course-details.html">Fashion & Technology</a></h4>
...
<div class="fun-fact-area bg-img pt-130 pb-100" style="background-image:url(assets2/img/bg/bg-6.jpg);">
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="single-count mb-30 count-one count-white">
                    <div class="count-img">
                        <img src="assets2/img/icon-img/funfact-1.png" alt="">
                    </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="single-count mb-30 count-two count-white">
                    <div class="count-img">
                        <img src="assets2/img/icon-img/funfact-2.png" alt="">
                    </div>
                    <div class="count-content">
            ...
            <div class="col-lg-6">
                ...
                <div class="blog-active">
                    <div class="single-blog">
                        <div class="blog-img">
                            <a href="blog-details.html"><img src="assets2/img/blog/blog-1.jpg" alt=""></a>
                        </div>
                    ...
                    <div class="single-blog">
                        <div class="blog-img">
                            <a href="blog-details.html"><img src="assets2/img/blog/blog-2.jpg" alt=""></a>
                        </div>
                        <div class="blog-content-wrap">
                            <span>Education</span>
                            <div class="blog-content">
                    ...
                    <div class="single-blog">
                        <div class="blog-img">
                            <a href="blog-details.html"><img src="assets2/img/blog/blog-3.jpg" alt=""></a>
                        </div>
                        <div class="blog-content-wrap">
                            <span>Education</span>
                            <div class="blog-content">
            ...
            <div class="col-lg-6">
                ...
                <div class="event-active-2 ml-70">
                    <div class="single-event single-event-2">
                        <div class="event-img">
                            <a href="event-details.html"><img src="assets2/img/event/event-4.jpg" alt=""></a>
    ...
    <div class="container">
        <div class="brand-logo-active owl-carousel">
            <div class="single-brand-logo">
                <a href="#"><img src="assets2/img/brand-logo/1.png" alt=""></a>
            </div>
            <div class="single-brand-logo">
                <a href="#"><img src="assets2/img/brand-logo/2.png" alt=""></a>
            </div>
            <div class="single-brand-logo">
                <a href="#"><img src="assets2/img/brand-logo/3.png" alt=""></a>
            </div>
            <div class="single-brand-logo">
                <a href="#"><img src="assets2/img/brand-logo/4.png" alt=""></a>
            </div>
            <div class="single-brand-logo">
                <a href="#"><img src="assets2/img/brand-logo/5.png" alt=""></a>
            </div>
            <div class="single-brand-logo">
                <a href="#"><img src="assets2/img/brand-logo/6.png" alt=""></a>
            </div>
            <div class="single-brand-logo">
                <a href="#"><img src="assets2/img/brand-logo/2.png" alt=""></a>
            </div>
...
<footer class="footer-area">
    <div class="footer-top bg-img default-overlay pt-130 pb-80" style="background-image:url(assets2/img/bg/bg-4.jpg);">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 col-sm-6">
                    <div class="footer-widget mb-40">
                        ...
                        <div class="footer-gallery">
                            <ul>
                                <li><a href="#"><img src="assets2/img/gallery/gallery-1.png" alt=""></a></li>
                                <li><a href="#"><img src="assets2/img/gallery/gallery-2.png" alt=""></a></li>
                                <li><a href="#"><img src="assets2/img/gallery/gallery-3.png" alt=""></a></li>
                                <li><a href="#"><img src="assets2/img/gallery/gallery-4.png" alt=""></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
