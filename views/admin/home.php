...
<html lang="en" class="no-js">
  <head>
    ...
    <meta name="description" content="Sistem Pendaftaran Peserta Didik Baru SMK Wikrama 1 Garut" />
  ...
  <body class="material-template">
                ...
                <div class="page-header">
                  <div class="row">
                    <div class="col-sm-4 col-md-4 col-lg-4">
                      <div class="photo">
                      <img src="assets3/images/wk.png" alt="">
                      </div>
                    </div>
                    ...
                    <div class="col-sm-8 col-md-8 col-lg-8">
                      <div class="title-block">
                        ...
                        <div class="owl-carousel text-rotation">                                    
                          ...
                          <!--</div>-->
                          <div class="item">
                            <div class="sp-subtitle">SMK Wikrama 1 Garut</div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="row">
                      ...
                      <div class="block-title">
                        ...
                        <ul class="info-list">
                          ...
                          <li><span class="title">5. Bawa bukti pendaftaran ke SMK Wikrama 1 Garut dengan membawa FC raport dan berkas pendukung lainnya untuk diverifikasi oleh panitia.</span></li>
                        </ul>
                      </div>
    ...
    <footer>
      <div class="copyrights">
        <p>© 2021,SMK Wikrama 1 Garut All rights reserved. <a href="http://mattkhojim.com"></a></p>
      </div>
    </footer>
